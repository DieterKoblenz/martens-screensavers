...
//-------------------Slow Rainbow Start ---------------------------------------------------
var frames_slow_rainbow = [];
var frame_slow_rainbow = [];
...
var animation_slow_rainbow = new Animation({
...
animation_slow_rainbow.register(function(err, result){
	...
	animation_slow_rainbow.on('screensaver_stop', function( screensaver_id ){
		Homey.log('Screensaver stopped')
	})
})
//-------------------Slow Rainbow Animation Stop ---------------------------------------------------
